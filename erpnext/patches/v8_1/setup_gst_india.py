...
<p>Please refer {gst_document_link} to know more about how to setup and implement GST in BuzzERP.</p>

<p>Please contact us at support@erpnext.com, if you have any questions.</p>

<p>Thanks,</p>
BuzzERP Team.
	""".format(gst_document_link="<a href='http://frappe.github.io/erpnext/user/manual/en/regional/india/'> BuzzERP GST Document </a>")

	try:
		sendmail_to_system_managers("[Important] BuzzERP GST updates", message)
